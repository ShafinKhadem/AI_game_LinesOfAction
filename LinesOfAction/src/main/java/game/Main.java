...
public class Main extends Application {
	...
	private static Object setScene(Stage window, String sceneFile) {
		try {
			FXMLLoader loader = new FXMLLoader(Main.class.getResource("/fxml/"+sceneFile));
...
//		dialog.setResizable(false);
	...
	public void start(Stage primaryStage) throws Exception {
		bg_white = new Image("images/bg_white.png", CELL_DIMENSION, CELL_DIMENSION, false, true, true);
		bg_black = new Image("images/bg_black.png", CELL_DIMENSION, CELL_DIMENSION, false, true, true);
		Image white_piece = new Image("images/chips_white.png", CELL_DIMENSION, CELL_DIMENSION, true, true, true);
		Image black_piece = new Image("images/chips_black.png", CELL_DIMENSION, CELL_DIMENSION, true, true, true);
		stateImage = new Image[]{white_piece, black_piece};
...
//		Resources aren't loaded yet, so don't try using new Image() before launch
		launch(args);
	}
}
